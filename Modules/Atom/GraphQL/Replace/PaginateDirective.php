...
namespace Modules\Atom\GraphQL\Replace;
...
use Nuwave\Lighthouse\Pagination\{PaginationManipulator,PaginationType,PaginationArgs};
...
GRAPHQL;
    ...
    public function getResolverFromArgument(string $argumentName): \Closure
    {
        ...
        $namespacedClassName = $this->namespaceClassName($className , \Config::get( 'lighthouse.namespaces.queries' , [ ] ) );

        return \Nuwave\Lighthouse\Support\Utils::constructResolver($namespacedClassName, $methodName);
    }
