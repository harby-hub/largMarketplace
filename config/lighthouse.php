<?php declare( strict_types = 1 ) ; return [
    ...
    */
    ...
    'schema_path' => base_path( 'Modules/Atom/schema.graphql' ) ,
    ...
    */
    ...
    'error_handlers' => [
        ...
        ( new class implements \Nuwave\Lighthouse\Execution\ErrorHandler { public function __invoke( ? \GraphQL\Error\Error $error, Closure $next ) : ?array {
            if ( $error -> getExtensions( ) [ 'WithTrace' ] ?? false ) return [
